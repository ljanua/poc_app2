...
- Decided (plan): Club = Coach ops for all club teams + Users mgmt (Coach only) within club; many per club; no S7a/S8
- Implementation tracked in `docs/plans/2026-07-14-001-feat-club-admin-role-plan.md`
