...
- Name: s1-player-list.spec.js >> S1 Player List team filter and add-player flow >> shows only coach-assigned teams in the dropdown for coach sessions
- Location: tests\playwright\s1-player-list.spec.js:52:3
