...
- Name: s1-player-list.spec.js >> S1 Player List team filter and add-player flow >> shows all available teams in the dropdown for system admin sessions
- Location: tests\playwright\s1-player-list.spec.js:62:3
