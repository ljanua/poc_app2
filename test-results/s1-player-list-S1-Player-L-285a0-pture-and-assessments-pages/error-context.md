...
- Name: s1-player-list.spec.js >> S1 Player List team filter and add-player flow >> bottom navigation routes to teams, capture, and assessments pages
- Location: tests\playwright\s1-player-list.spec.js:16:3
