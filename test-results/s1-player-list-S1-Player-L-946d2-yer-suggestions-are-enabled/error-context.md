...
- Name: s1-player-list.spec.js >> S1 Player List team filter and add-player flow >> requires selecting a specific team before add-player suggestions are enabled
- Location: tests\playwright\s1-player-list.spec.js:110:3
