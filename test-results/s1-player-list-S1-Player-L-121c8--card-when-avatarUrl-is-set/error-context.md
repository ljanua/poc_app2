...
- Name: s1-player-list.spec.js >> S1 Player List team filter and add-player flow >> shows uploaded avatar image on player card when avatarUrl is set
- Location: tests\playwright\s1-player-list.spec.js:131:3
