...
- Name: s1-player-list.spec.js >> S1 Player List team filter and add-player flow >> shows emoji avatar for players without an uploaded photo
- Location: tests\playwright\s1-player-list.spec.js:124:3
